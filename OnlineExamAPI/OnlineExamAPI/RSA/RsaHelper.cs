...
namespace OnlineExamAPI.RSA
{
    public class RsaHelper
    {
        ...
        {   
            ...
            string public_pem = @"C:\Users\nilesh\Desktop\LTIFINAL(local use)\api\OnlineExamAPi\OnlineExamAPI\OnlineExamAPI\keys\PublicKey.pem";
            string private_pem = @"C:\Users\nilesh\Desktop\LTIFINAL(local use)\api\OnlineExamAPi\OnlineExamAPI\OnlineExamAPI\keys\PrivateKey.pem"; 
